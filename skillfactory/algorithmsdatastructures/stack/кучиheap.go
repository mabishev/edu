// Перед началом работы с кучей следует вызвать специальную функцию Init() пакета heap. Init() устанавливает инварианты кучи, необходимые для других подпрограмм в этом пакете,
// в частности функциями Push() и Pop() самого пакета (не объекта, реализующего интерфейс heap.Interface)
package main
